...
export default function PasoPage() {
  ...
  const steps: any[] = [
    { name: "Sur Place", href: "/latin/paso/sur_place", category: "bronze", isRestricted: true },
    { name: "Basic Movement", href: "/latin/paso/basic_movement", category: "bronze", isRestricted: true },
    { name: "Chasses to Right or Left", href: "/latin/paso/chasses_r_l", category: "bronze", isRestricted: true },
    { name: "Drag", href: "/latin/paso/drag", category: "bronze", isRestricted: true },
    { name: "Deplacement (Attack)", href: "/latin/paso/deplacement", category: "bronze", isRestricted: true },
    { name: "Promenade Link (also Promenade Close)", href: "/latin/paso/promenade_link", category: "bronze", isRestricted: true },
    { name: "Promenade", href: "/latin/paso/promenade", category: "bronze", isRestricted: true },
    { name: "Ecart", href: "/latin/paso/ecart", category: "bronze", isRestricted: true },
    { name: "Fallaway Whisk", href: "/latin/paso/fallaway_whisk", category: "bronze", isRestricted: true },
    { name: "Appel", href: "/latin/paso/appel", category: "restricted", isRestricted: true },
    { name: "Separation", href: "/latin/paso/separation", category: "bronze", isRestricted: true },
