...
export default function SambaPage() {
  ...
  const steps: any[] = [
    ...
    { name: "Travelling Bota Fogos Forward", href: "/latin/samba/travelling_bota_fogos_forward", category: "prebronze", isRestricted: true },
    { name: "Travelling Bota Fogos Backward", href: "/latin/samba/travelling_bota_fogos_backward", category: "prebronze", isRestricted: true },
