...
export default function RumbaPage() {
  ...
  const steps: any[] = [
    { name: "Basic Movements (Closed, Open, In Place, Alternative)", href: "/latin/rumba/basic_movements", category: "prebronze", isRestricted: true },
    ...
    { name: "Spot Turns (including Switch and Underarm Turns)", href: "/latin/rumba/spot_turns", category: "prebronze", isRestricted: true },
