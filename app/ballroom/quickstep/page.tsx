...
export default function QuickstepPage() {
  ...
  const steps: any[] = [
    { name: "Quarter turn to Right", href: "/ballroom/quickstep/quarter_turn_r", category: "bronze", isRestricted: true },
    { name: "Progressive Chasse", href: "/ballroom/quickstep/progressive_chasse", category: "bronze", isRestricted: true },
    { name: "Forward Lock", href: "/ballroom/quickstep/forward_lock", category: "bronze", isRestricted: true },
    { name: "Natural Turn", href: "/ballroom/quickstep/natural_turn", category: "bronze", isRestricted: true },
    { name: "Natural Turn with Hesitation", href: "/ballroom/quickstep/natural_turn_hesitation", category: "bronze", isRestricted: true },
    { name: "Natural Pivot Turn", href: "/ballroom/quickstep/natural_pivot_turn", category: "bronze", isRestricted: true },
    { name: "Natural Spin Turn", href: "/ballroom/quickstep/natural_spin_turn", category: "bronze", isRestricted: true },
