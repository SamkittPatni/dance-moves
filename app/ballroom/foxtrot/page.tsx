...
export default function FoxtrotPage() {
  ...
  const steps: any[] = [
    ...
    { name: "Basic Weave", href: "/ballroom/foxtrot/basic_weave", category: "bronze", isRestricted: true },
    ...
    { name: "Hover Feather", href: "/ballroom/foxtrot/hover_feather", category:"restricted", isRestricted: true },
    ...
    { name: "Open Telemark, Natural Turn, Outside Swivel and Feather Ending", href: "/ballroom/foxtrot/open_telemark_natural_turn_outside_swivel_feather_ending", category:"silver", isRestricted: true },
    ...
    { name: "Curved Feather", href: "/ballroom/foxtrot/curved_feather", category:"gold", isRestricted: true },
    ...
    { name: "Extended Reverse Wave", href: "/ballroom/foxtrot/extended_reverse_wave", category:"restricted", isRestricted: true },
  ];
