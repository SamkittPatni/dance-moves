  ...
  return (
    <>
      <div className="flex flex-col w-full h-full bg-black/75 text-justify md:px-10">
        <h1 className="font-serif font-bold text-center">Chasse from Promenade Position</h1>
        ...
        <div className="flex flex-col justify-center py-5">
          ...
          <Suspense fallback={<p>Loading video...</p>}>
            <VideoLink videoID="ebcsqFtjmEM" start={8} end={138} />
          </Suspense>
        </div>
...
// Video:-
// https://www.youtube.com/watch?v=ebcsqFtjmEM
// Timestamp: 0:08-2:18
