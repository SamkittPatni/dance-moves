...
export default function Page() {
  ...
  return (
    <>
      <div className="w-full h-full bg-black/75 text-justify px-10">
        ...
        <div className="flex flex-col justify-center py-5">
          ...
          <Suspense fallback={<p>Loading video...</p>}>
            <VideoLink videoID="j6bP6I4Vf-M" start={69} end={95} />
          </Suspense>
        </div>
        <div className="flex flex-row py-5">
          <div className="w-full text-center mx-2 py-5 bg-black/75">
